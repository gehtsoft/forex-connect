    ...
    private static void printOrders(O2GTableManager tableManager) {
        ...
        try {
            ...
            for(int ii=0; ii<ordersTable.size();ii++) {
                ...
                System.out.print("Order: " + orderRow.getOrderID() + "; ");
                System.out.print("AccountID=" + orderRow.getAccountID() + "; ");
                System.out.print("OfferID=" + orderRow.getOfferID() + "; ");
                System.out.print("Type=" + orderRow.getType() + "; ");
                System.out.print("Rate=" + orderRow.getRate() + "; ");
                System.out.print("Buy/Sell=" + orderRow.getBuySell() + "; ");
                System.out.print("Status=" + orderRow.getStatus() + "; ");
                System.out.print("Limit=" + orderRow.getLimit() + "; ");
                System.out.print("Stop=" + orderRow.getStop() + "\n");
            }
        } finally {
