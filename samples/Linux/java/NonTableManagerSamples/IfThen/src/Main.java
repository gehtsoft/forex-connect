...
public class Main {
    public static void main(String[] args) {
        ...
        try {
            ...
            if (statusListener.waitEvents() && statusListener.isConnected()) {
                ...
                O2GRequest request = createIfThenRequest(session, offer.getOfferID(), account.getAccountID(), iAmount, dRateIf, dRateStop);
                if (request == null) {
    ...
    private static O2GRequest createIfThenRequest(O2GSession session, String sOfferID, String sAccountID, int iAmount, double dRateIf, double dRateStop) throws Exception {
        ...
        valuemapIf.setString(O2GRequestParamsEnum.ORDER_TYPE, Constants.Orders.StopEntry);
        valuemapIf.setString(O2GRequestParamsEnum.ACCOUNT_ID, sAccountID);
        valuemapIf.setString(O2GRequestParamsEnum.OFFER_ID, sOfferID);
        valuemapIf.setString(O2GRequestParamsEnum.BUY_SELL, Constants.Sell);
        ...
        valuemapStop.setString(O2GRequestParamsEnum.ORDER_TYPE, Constants.Orders.StopEntry);
        valuemapStop.setString(O2GRequestParamsEnum.ACCOUNT_ID, sAccountID);
        valuemapStop.setString(O2GRequestParamsEnum.OFFER_ID, sOfferID);
        valuemapStop.setString(O2GRequestParamsEnum.BUY_SELL, Constants.Buy);
