...
namespace ArgParser
{
    public class SampleParams
    {
        ...
        public static readonly String ACCOUNT2_HELP_STRING = "/account | --account\nAn account (for second conenction) which you want to use in sample. Optional parameter\n";
        ...
        public SampleParams(String[] args)
        {
            ...
            mAccountID2 = GetArgument(args, "account2");
