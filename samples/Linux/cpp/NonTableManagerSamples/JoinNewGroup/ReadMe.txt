...
Brief
===============================================================================
This sample shows how to create an OCO order using two already existing entry orders.
The sample performs the following actions:
1. Login.
2. Create an OCO order using two already existing entry orders.
...
/primaryid | --primaryid 
First order, which you want to add to a new OCO group.

/secondaryid | --secondaryid 
Second order, which you want to add to a new OCO group.
