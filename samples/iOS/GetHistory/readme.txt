...
Brief
===============================================================================
This sample application shows how to display a chart with a price history for a specific symbol.
...
3) After the successful login, the application shows a list of available Symbols with their Bid and Ask prices.
4) The user taps a symbol.
5) The application shows a chart with a price history for that symbol. The price history has default dates and timeframe.
6) The user taps "Options" on the same screen.
7) The application prompts the user to enter the price history parameters: Start date, End date, and Timeframe.
8) The user enters the price history parameters and taps "Save".
9) The application shows a chart with a price history for the same symbol – this time, with the user-defined parameters.
