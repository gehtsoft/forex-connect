...
5) The application prompts the user to enter the order parameters for that symbol: Sell/Buy, Amount, Rate, and TrueMarket/EntryStop/EntryLimit.
6) The user enters the order parameters and taps "OK".
7) The application creates the order for that symbol.
