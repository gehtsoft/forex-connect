...
namespace JoinExistingGroup
{
    class Program
    {
        ...
        {
            Console.WriteLine("{0}: ContingencyID='{1}', OrderID='{2}', AccountID='{3}'", procName, prm.ContingencyID, prm.OrderID, prm.AccountID);
        }
        ...
        class SampleParams
        {
            ...
            {
                mContingencyID = GetRequiredArgument(args, "ContingencyID");
