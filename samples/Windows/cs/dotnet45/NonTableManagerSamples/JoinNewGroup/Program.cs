    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            try
            {
                ...
                PrintSampleParams("JoinNewGroup", loginParams, sampleParams);
        ...
        {
            Console.WriteLine("{0}: PrimaryID='{1}', SecondaryID='{2}', AccountID='{3}'", procName, prm.PrimaryID, prm.SecondaryID, prm.AccountID);
        }
        ...
        class SampleParams
        {
            ...
            {
                mPrimaryID = GetRequiredArgument(args, "PrimaryID");
                mSecondaryID = GetRequiredArgument(args, "SecondaryID");
