...
{
    public delegate void IPeriodCollection_Updated(IPeriodCollection collection, int index);

    /// <summary>
    /// Interface to the collection of the price periods
    /// </summary>
    public interface IPeriodCollection : IEnumerable<IPeriod>, IDisposable
    {
        /// <summary>
