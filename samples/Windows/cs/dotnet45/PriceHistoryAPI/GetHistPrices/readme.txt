...
==================================================================================
Change the GetHistPrices.config file by putting your information in the "appSettings" section.
...
{DATETO} - The date and time until which you want to receive historical prices.
...
OpenPriceCandlesMode - If it's "firsttick" then the opening price of a period equals the first price update inside the period.
