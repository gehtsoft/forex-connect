...
namespace GUISample
{
    ...
    class PeriodCollection : IPeriodCollection
    {
        ...
        /// </summary>
        private PriceAPIController mController;
        ...
        /// <summary>
        /// Event of PriceAPIController: When a new tick comes
        /// </summary>
        ...
        {
            return (long)(time.Hour * 60 + time.Minute) + ((long)Math.Floor(time.ToOADate())) * 1440;
        }
    }
}
