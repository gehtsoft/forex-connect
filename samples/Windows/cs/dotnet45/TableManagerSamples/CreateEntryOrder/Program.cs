    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            try
            {
                ...
                PrintSampleParams("CreateEntryOrder", loginParams, sampleParams);
        ...
        {
            Console.WriteLine("{0}: Instrument='{1}', BuySell='{2}', Rate='{3}', Lots='{4}', AccountID='{5}', ExpireDate='{6}'", procName, prm.Instrument, prm.BuySell, prm.Rate, prm.Lots, prm.AccountID, prm.ExpireDate);
        }
