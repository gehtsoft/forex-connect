...
public class Main {
    public static void main(String[] args) {
        ...
        try {
            ...
            if (statusListener.waitEvents() && statusListener.isConnected()) {
                ...
                O2GRequest request = createOTORequest(session, offer.getOfferID(), account.getAccountID(), iAmount, dRatePrimary, dRateSecondary);
                if (request == null) {
    ...
    // Create OTO request
    private static O2GRequest createOTORequest(O2GSession session, String sOfferID, String sAccountID, int iAmount, double dRatePrimary, double dRateSecondary) throws Exception {
        ...
        valuemapSecondary.setString(O2GRequestParamsEnum.ORDER_TYPE, Constants.Orders.StopEntry);
        valuemapSecondary.setString(O2GRequestParamsEnum.ACCOUNT_ID, sAccountID);
        valuemapSecondary.setString(O2GRequestParamsEnum.OFFER_ID, sOfferID);
        valuemapSecondary.setString(O2GRequestParamsEnum.BUY_SELL, Constants.Buy);
