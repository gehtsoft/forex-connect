...
ant rebuild
For example,
C:\Program Files\CandleWorks\ForexConnectAPI\samples\java\TableManagerSamples\CloseAllPositions>ant rebuild
...
ant run
For example,
C:\Program Files\CandleWorks\ForexConnectAPI\samples\java\TableManagerSamples\CloseAllPositions>ant run
