...
ant rebuild
For example,
C:\Program Files\CandleWorks\ForexConnectAPI\samples\java\TableManagerSamples\NetStopLimit>ant rebuild
...
ant run
For example,
C:\Program Files\CandleWorks\ForexConnectAPI\samples\java\TableManagerSamples\NetStopLimit>ant run
