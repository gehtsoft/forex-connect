...
ant rebuild
For example,
C:\Program Files\CandleWorks\ForexConnectAPI\samples\java\NonTableManagerSamples\RemoveFromGroup>ant rebuild
...
ant run
For example,
C:\Program Files\CandleWorks\ForexConnectAPI\samples\java\NonTableManagerSamples\RemoveFromGroup>ant run
...
{ORDERID} - order, which you want to remove from a contingency group.
        Mandatory argument.
