...
ant rebuild
For example,
C:\Program Files\CandleWorks\ForexConnectAPI\samples\java\NonTableManagerSamples\JoinExistingGroup>ant rebuild
...
ant run
For example,
C:\Program Files\CandleWorks\ForexConnectAPI\samples\java\NonTableManagerSamples\JoinExistingGroup>ant run
...
{CONTINGENCYID} - contingency ID of group, to which you want to join
        an entry order. Mandatory argument.
{ORDERID} - order, which you want to join to existing contingency group.
        Mandatory argument.
