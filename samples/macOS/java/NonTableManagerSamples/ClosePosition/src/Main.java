...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            if (statusListener.waitEvents() && statusListener.isConnected()) {
                ...
                O2GTradeRow trade = getTrade(session, sampleParams.getAccountID(), offer.getOfferID(), responseListener);
                if (trade == null) {
    ...
    private static O2GTradeRow getTrade(O2GSession session, String sAccountID, String sOfferID, ResponseListener responseListener) throws Exception
    {
        ...
        if (response != null) {
            ...
            if (readerFactory != null) {
                ...
                for (int i = 0; i < tradesResponseReader.size(); i++) {
                    ...
                    if (sOfferID.equals(trade.getOfferID())) {
                        bHasTrade = true;
                        break;
                    }
                }
